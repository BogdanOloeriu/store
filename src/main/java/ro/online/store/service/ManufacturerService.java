...
public class ManufacturerService {
    ...
    public ManufacturerInfoDTO getManufacturerById(Integer id){
        ManufacturerEntity manufacturerEntity = manufacturerRepository
                .findById(id)
                .orElseThrow(() -> new ManufacturerCustomException("Could not find the Manufacturer for id:" + id));
    ...
    public List<ManufacturerInfoDTO> findAll(){
        ...
        manufacturerRepository
                .findAll()
                .forEach(manufacturerEntity -> manufacturerEntityList.add(manufacturerEntity));

        return manufacturerEntityList.stream()
